...
// Modify the SQL query to select the 'level' field
        ...
        <main>
            <table style="font-size: 18px; border:1px solid #ddd;padding-bottom:70px; border-collapse: collapse;">
                <tr>
                    ...
                    <th>Gender</th>
                    <th>Department</th>
                    <th>Level</th> <!-- Add Level column header -->
                    <th>PROFILE</th>
                </tr>
                <?php while ($student = $sql_query->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td><a href="update.php?student_id=<?php echo $student['id']; ?>">Update Student-Info</a></td>
                    </tr>
                <?php } ?>
