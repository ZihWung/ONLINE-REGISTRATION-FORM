...
if(isset($_GET['faculty_id'])){
    ...
    $sql_department = "SELECT * FROM department WHERE faculty_id='$faculty_id' ";
    $query_department = mysqli_query($con, $sql_department) or die(mysqli_error($con));
        ...
        <div>
            ...
            <main>
                <form method="post" action="">
                    <fieldset>
                        <legend>Admission of a new student Information</legend>
                        Faculty:
