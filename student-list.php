...
$sql = "SELECT student.*, department.name AS department_name FROM student
...
<div class="container">
    <div>
        ...
        <main>
            <table style="font-size: 20px; border:1px solid #ddd;padding-bottom:70px; border-collapse: collapse;">
                <tr>
                    <th>SID</th>
                    <th>FULL NAME</th>
                    <th>DATE OF BIRTH</th>
                ...
                <?php while ($student = $sql_query->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td><a href="student-profile.php?student_id=<?php echo $student['id']; ?>">Profile</a></td>
                    </tr>
                <?php } ?>
                <h2>Student List: <?php echo $sql_query->num_rows; ?></h2>
            </table>
        </main>
    </div>
</div>
